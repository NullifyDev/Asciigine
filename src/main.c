...
int main(void)
{
	...
	{
		key_new('w', moveup,      args_create(1, (void*[]) { &heart })),
		key_new('s', movedown,    args_create(1, (void*[]) { &heart })),
		key_new('a', moveleft,    args_create(1, (void*[]) { &heart })),
		key_new('d', moveright,   args_create(1, (void*[]) { &heart })),
		key_new('q', engine_exit, args_create(1, (void*[]) { &heart }))
	});
